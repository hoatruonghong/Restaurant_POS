                    ...
                    <?php if (mysqli_num_rows($cart) > 0) { while ($row = mysqli_fetch_assoc($cart)) { ?>
                        <div class="product-in-cart">
                            ...
                            <div style="width: 40%; text-align:right;">
                                <button style="margin-right:5px;border-color:white;background-color:white"><img src="../images/close.png" height="11px"></button>
                                <br><b style="color: red; font-size:18px;padding-right:10px;"><?php echo $row['price'];?> đ</b>
                            </div>
                        </div>
